...
* **Windows Host Application (.NET 8):** [Download Mirror.Tool.zip (v1.0)](https://github.com/thefuzzydeveloper/Mirror-Tool-Android/releases/download/v1.5/Mirror.Tool.zip)
* **Android Receiver App:** [Download MirrorSync.apk (v1.0)](https://github.com/thefuzzydeveloper/Mirror-Tool-Android/releases/download/v1.5/MirrorSync.apk)
